import { Fatal } from "../vendor/Errors"
declare global {
    namespace Arcaela {
        namespace HTTP {
            /**
        ...
        namespace XHRequest {
             ...
             */
            type BasicValues = string | number | object | string[] | number[] | []
            /**
             ...
             */
            type ObjectOnly<B> = Record<string|number, B>
            /**
            ...
            interface EventListener {
                before<R extends object, O extends object>(req: R, opt: O) : void;
                success<R extends Response>(res: R) : Promise<any>;
             ...
             */
            type Driver = EventListener[ "before" ];
            /**
            ...
            type Options = {
                ...
                driver : string
                drivers : Record<string, EventListener['before']>
            }
        }
    }
}
...
class XHRequest {
     ...
     */
    constructor(url?: string | URL, request?: Arcaela.XHRequest.RequestInit){
